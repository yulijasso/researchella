...
export async function initTables() {
  ...
  try {
    await db.execute(`ALTER TABLE files ADD COLUMN pdf_data TEXT`);
    console.log('Added pdf_data column to files table');
  } catch (e) {
  ...
  try {
    ...
    console.log('Added sources column to messages table');
  } catch (e) {
    // Column likely already exists, ignore
  }
