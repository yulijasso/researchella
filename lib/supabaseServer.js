...
// Log whether service role key is available (helpful for debugging)
if (supabaseServiceKey) {
  console.log('✅ SUPABASE_SERVICE_ROLE_KEY is set (length: ' + supabaseServiceKey.length + ')');
} else {
  console.warn('⚠️ SUPABASE_SERVICE_ROLE_KEY is NOT set - database operations will fail with RLS');
}
